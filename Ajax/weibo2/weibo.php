...
//创建数据库之类的
$db=@mysql_connect('localhost', 'root', '045412') or @mysql_connect('localhost', 'root', 'admin');

mysql_query("set names 'utf8'");
mysql_query('CREATE DATABASE zlq_weibo');

mysql_select_db('zlq_weibo');

$sql= <<< END
CREATE TABLE  `zlq_weibo`.`weibo` (
